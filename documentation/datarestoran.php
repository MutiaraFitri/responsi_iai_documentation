  ...
  <div class="row">
      <h5 class="ui header" style="font-size: 18px">
          ...
          <div class="sub header" style="display: inline-block;">
              <span class="segment_sub_heading">
                  https://mahdojan.000webhostapp.com/json/read_all.php</span>
          </div>
      </h5>
  </div>
  <div class="row">
        ...
        <div class="">
          <div class="kotak-koding">
            ...
            <div class="row row-isi">
                ...
                <div class="isi">
<pre><span class="variabel">$curl</span> = curl_init();
curl_setopt_array(<span class="variabel">$curl</span>, array(
  CURLOPT_URL => <span class="linkku">"https://mahdojan.000webhostapp.com/json/read_all.php"</span>,
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => <span class="linkku">""</span>,
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
  CURLOPT_CUSTOMREQUEST => <span class="linkku">"GET"</span>,
  CURLOPT_HTTPHEADER => array(
    <span class="linkku">"key: your-api-key"</span>
  ),
));

<span class="variabel">$response</span> = curl_exec(<span class="variabel">$curl</span>);
<span class="variabel">$err</span> = curl_error(<span class="variabel">$curl</span>);

curl_close(<span class="variabel">$curl</span>);

if (<span class="variabel">$err</span>) {
  echo <span class="linkku">"cURL Error #:"</span> . <span class="variabel">$err</span>;
} else {
  echo <span class="variabel">$response</span>;
}
                    </pre>
                </div>
            </div>
